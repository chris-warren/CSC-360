...
void swap(struct node* ref1, struct node* ref2) {
    ...
    // ref1 right before ref2
    if(ref1->next->data == ref2->data){
         px1->next = ref2;
         ref2->prev = px1;
         ref2->next = ref1;
         ...
         ref1->next = nx2;
         nx2->prev = ref1;
    //ref 2 right before ref1
    }else if(ref2->next->data == ref1->data){
         px2->next = ref1;
         ref1->prev = px2;
         ref1->next = ref2;
	...
	if(ref2->prev == NULL){
		...
		head = ref2;
	}else if(ref2->next == NULL){
		struct node* tail = end(ref2);
		tail = ref2;
	}
...
struct node* shift_left(struct node* ref, int n) {
    ...
    while(n>0){
         ...
         struct node* ref2 = prev(ref);
         struct node* px2 = prev(ref2);
         struct node* nx1 = next(ref);
